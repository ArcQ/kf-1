...
namespace kf1 {
void JsEventEmitter::updatePosition(int c_key, models::Pt c_position) {
...
void JsEventEmitter::updateCharacterState(int c_key, std::string character_state) {
...
void JsEventEmitter::updateOrientation(int c_key, std::string&& orientation) {
